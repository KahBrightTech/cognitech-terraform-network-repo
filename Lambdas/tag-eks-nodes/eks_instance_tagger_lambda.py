"""
AWS Lambda: Auto-tag EC2 instances launched by EKS with a sequential Name.

Trigger: EventBridge rule matching EC2 instance state-change to "running":
  {
    "source": ["aws.ec2"],
...
Naming convention:
  <cluster-name>-node-1, <cluster-name>-node-2, etc.
...
Lambda configuration:
  - Runtime: Python 3.12
  - Handler: eks_instance_tagger_lambda.lambda_handler
  - Timeout: 90 seconds (to allow retries for tag propagation)
  - Memory: 128 MB
"""
