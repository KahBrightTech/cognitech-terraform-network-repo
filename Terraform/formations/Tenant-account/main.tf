  ...
  eks = merge(
    ...
    },
    {
      eks_addons = each.value.eks_addons != null ? merge(
        ...
        (each.value.eks_addons.cloudwatch_observability_role_key != null || each.value.eks_addons.cloudwatch_observability_role_arn != null || each.value.eks_addons.fluent_bit_role_key != null) ?
        {
          ...
          fluent_bit_role_arn                 = each.value.eks_addons.fluent_bit_role_key != null ? module.iam_roles[each.value.eks_addons.fluent_bit_role_key].iam_role_arn : each.value.eks_addons.fluent_bit_role_arn
        } : {},
