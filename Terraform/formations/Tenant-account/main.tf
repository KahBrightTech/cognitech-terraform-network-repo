  ...
  eks = merge(
    ...
    },
    {
      eks_addons = each.value.eks_addons != null ? merge(
        ...
        (each.value.eks_addons.cloudwatch_observability_role_key != null || each.value.eks_addons.cloudwatch_observability_role_arn != null) ?
        {
          ...
          fluent_bit_firehose_delivery_stream = each.value.eks_addons.fluent_bit_firehose_delivery_stream_key != null ? module.firehose_streams[each.value.eks_addons.fluent_bit_firehose_delivery_stream_key].name : each.value.eks_addons.fluent_bit_firehose_delivery_stream
        } : {},
