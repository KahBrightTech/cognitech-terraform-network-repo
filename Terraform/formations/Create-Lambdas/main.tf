...
module "Start_Instance" {
  source   = "git::https://github.com/njibrigthain100/Cognitech-terraform-iac-modules.git//terraform/modules/Lambdas/Start-Instance?ref=v1.97"
...
#   source   = "git::https://github.com/njibrigthain100/Cognitech-terraform-iac-modules.git//terraform/modules/Lambdas/Stop-Instance?ref=v1.97"
#   for_each = (var.Lambdas != null) ? { for item in var.Lambdas : item.function_name => item } : {}
#   common   = var.common
#   Lambda   = each.value
# }
