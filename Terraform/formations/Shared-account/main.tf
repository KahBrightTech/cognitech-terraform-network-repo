...
#--------------------------------------------------------------------
module "ip_sets" {
  source = "git::https://github.com/njibrigthain100/Cognitech-terraform-iac-modules.git//terraform/modules/Waf-ipsets?ref=v1.3.98"
...
#--------------------------------------------------------------------
module "rule_groups" {
  source = "git::https://github.com/njibrigthain100/Cognitech-terraform-iac-modules.git//terraform/modules/WAF-rulegroup?ref=v1.3.98"
  for_each = var.wafs != null ? {
    for item in flatten([
...
#--------------------------------------------------------------------
module "waf" {
  source   = "git::https://github.com/njibrigthain100/Cognitech-terraform-iac-modules.git//terraform/modules/WAF?ref=v1.3.98"
